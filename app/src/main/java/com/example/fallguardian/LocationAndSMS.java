...
class LocationAndSMS {
    ...
    ///permissions
    public static final int MY_PERMISSIONS_REQUEST_SEND_SMS_AND_LOCATION = 99;
    ...
    public void askPermissions(){
        ...
        if (ContextCompat.checkSelfPermission(context,
            ...
            ActivityCompat.requestPermissions((Activity) context,
                    ...
                    MY_PERMISSIONS_REQUEST_SEND_SMS_AND_LOCATION);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode,String permissions[], int[] grantResults) {
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_SEND_SMS_AND_LOCATION: {
    ...
    public void getLocationAndSendSMS(){
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions((Activity) context, new String[]{Manifest.permission.ACCESS_FINE_LOCATION,Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_BACKGROUND_LOCATION}, MY_PERMISSIONS_REQUEST_SEND_SMS_AND_LOCATION);
        }
        else{
